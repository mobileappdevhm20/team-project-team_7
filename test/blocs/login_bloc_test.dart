...
void main() {
  ...
  blocTest(
    ...
    expect: [isA<LoginState>().having((source) => source.isEmailValid, "email should be valid", true)],
  );
  ...
  blocTest(
    ...
    expect: [isA<LoginState>().having((source) => source.isEmailValid, "email should not be valid", false)],
  );
  ...
  blocTest(
    ...
    expect: [isA<LoginState>().having((source) => source.isPasswordValid, "password should be valid", true)],
  );
  ...
  blocTest(
    ...
    expect: [isA<LoginState>().having((source) => source.isPasswordValid, "password should not be valid", false)],
  );
